...
public class JogoDaVelhaAntigo extends JFrame {
	ImageIcon iconCirculo = new ImageIcon(getClass().getResource("/partePrincipal/brl.png"));
	ImageIcon iconX = new ImageIcon(getClass().getResource("/partePrincipal/xis.png"));
